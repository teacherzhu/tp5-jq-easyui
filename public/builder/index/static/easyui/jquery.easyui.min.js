...
var s=$(_267).find("div.panel:visible,div.accordion:visible,div.tabs-container:visible,div.template:visible,.easyui-fluid:visible").filter(function(_269,el){
...
var _3bf="template-button-"+_3be[dir];
...
}},_3bb,{cls:((_3bb.cls||"")+" template-panel template-panel-"+dir),bodyCls:((_3bb.bodyCls||"")+" template-body")});
pp.panel(_3bd);
_3bc[dir]=pp;
var _3c0={north:"s",south:"n",east:"w",west:"e"};
var _3c1=pp.panel("panel");
if(pp.panel("options").split){
_3c1.addClass("template-split-"+dir);
}
_3c1.resizable($.extend({},{handles:(_3c0[dir]||""),disabled:(!pp.panel("options").split),onStartResize:function(e){
_3a9=true;
if(dir=="north"||dir=="south"){
var _3c2=$(">div.template-split-proxy-v",_3ba);
}else{
var _3c2=$(">div.template-split-proxy-h",_3ba);
}
...
if(dir=="north"||dir=="south"){
var _3c5=$(">div.template-split-proxy-v",_3ba);
_3c5.css("top",e.pageY-$(_3ba).offset().top-_3c5.height()/2);
}else{
var _3c5=$(">div.template-split-proxy-h",_3ba);
...
var icon="template-button-"+_3d6[dir];
var p=$("<div></div>").appendTo(_3cc);
p.panel($.extend({},$.fn.layout.paneldefaults,{cls:("template-expand template-expand-"+dir),title:"&nbsp;",iconCls:(_3d0.hideCollapsedContent?null:_3d0.iconCls),closed:true,minWidth:0,minHeight:0,doSize:false,region:_3d0.region,collapsedSize:_3d0.collapsedSize,noheader:(!isns&&_3d0.hideExpandTool),tools:((isns&&_3d0.hideExpandTool)?null:[{iconCls:icon,handler:function(){
_3dd(_3cc,_3cd);
return false;
}}])}));
...
cc.push(opts.iconCls?" template-expand-with-icon":"");
